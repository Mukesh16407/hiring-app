  ...
  return (
    <div className="mt-20 flex flex-col gap-10 mb-10">
      ...
      <p className="text-gray-600 text-md">
        HIRING is an employment agency, which helps companies/employers get
      ...
      <h1 className="text-center text-3xl font-semibold text-primary">
        ...
        <p className="text-gray-600">
            ...
            Ipsam possimus eaque laudantium ratione repellat asperiores 
            accusamus veniam. Voluptates assumenda, quam autem deleniti earum eos 
            quae repellendus tempore nulla. Totam, dolorem!
            Lorem ipsum dolor sit amet consectetur adipisicing elit. 
            Eos eius labore in est accusamus voluptate fugit minus hic cupiditate? 
            Quidem nihil optio vero officia labore a sint odit temporibus ratione?
          
        </p>
        <div className='relative'>
             <img src="./office.jpg" alt="" className="rounded-2xl m-auto"/>
